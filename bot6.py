#This bot collects data on 4 weeks of tiktok's top
#tracks. For each unique artist, the program calculates the total
#wikipedia views, returning the artist with the most wikipedia
#views. 
